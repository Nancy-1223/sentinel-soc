    ...
    <AnimatePresence>
      {alert && (
        <motion.div
          ...
          className={`hover-glow-card fixed bottom-5 right-5 z-50 w-[min(380px,calc(100vw-2rem))] rounded-lg border bg-white/90 p-4 shadow-[0_16px_42px_rgba(15,23,42,.16)] backdrop-blur-xl ${tone}`}
        >
